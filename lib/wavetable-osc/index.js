...
function Oscillator(type, size, alias, phase = 0){
  if (!(this instanceof Oscillator)) return new Oscillator(type, size, alias, phase);
...
function factory(type){
  return function(size, alias, phase){
    var osc = Oscillator(type, size, alias, phase);
